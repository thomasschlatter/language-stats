...
import { cycleMoveMode, toggleBackgroundMode } from '../stores/UserStore'
...
export default function HelperButtonGroup() {
  ...
  const moveMode = useAppSelector((state) => state.user.moveMode)
  ...
  return (
    <Backdrop>
      <div className="wrapper-group">
        {roomJoined && (
          <Tooltip
            title={
              moveMode === 'joystick'
                ? 'Movement: on-screen joystick (tap to switch to tap-to-walk)'
                : 'Movement: tap-to-walk (tap to switch to joystick)'
            }
          >
            <StyledFab size="small" onClick={() => dispatch(cycleMoveMode())}>
              {moveMode === 'joystick' ? <VideogameAssetIcon /> : <TouchAppIcon />}
            </StyledFab>
          </Tooltip>
        )}
        {showRoomInfo && (
        ...
        {showLegal && (
          <Wrapper>
            <Title>Terms of Service, Privacy, etc.</Title>
            <IconButton className="close" onClick={() => setShowLegal(false)} size="small">
              <CloseIcon />
            </IconButton>
            <ul>
              <li>
                <strong><Link href="/terms">Terms of Service</Link></strong>
              </li>
              <li>
                <strong><Link href="/privacy">Privacy Policy</Link></strong>
              </li>
              <li>
                <strong><Link href="/cookies">Cookie Policy</Link></strong>
              </li>
              <li>
                <strong><Link href="/disclaimer">Disclaimer</Link></strong>
              </li>
              <li>
                <strong><Link href="/contact">Contact</Link></strong>
              </li>
            </ul>
            <p className="tip">
              <LightbulbIcon />
      ...
      <ButtonGroup>
        ...
        <Tooltip title="Terms of Service and Privacy">
          <StyledFab size="small" onClick={() => {
