...
const COLS = `m.id, m.body, m.created_at, u.id AS author_id, u.username AS author, u.avatar AS author_avatar, u.avatar_image AS author_avatar_image, bl.code AS body_lang`;
